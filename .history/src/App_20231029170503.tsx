                      ...
                      <div className="App">
                        <LineChart width={500} height={600} data={graphDatasets}>
                          ...
                          <XAxis
                            ...
                            tickFormatter={(value) => `${value.toExponential()}`} // 指数表示に変換
                          ...
                          <Tooltip
                            formatter={(value, name, props) => {
                              if (props.payload && props.payload[0]) {
                                const xValue = props.payload[0].value; // 横軸の値
                                const yValue = value; // 縦軸の値
                                return [`x: ${Number(xValue).toExponential()}`, `y: ${Number(yValue).toExponential()}`];
                              }
                              return [];
                            }}
                          />
                          ...
                          <Tooltip
                            formatter={(value, name, props, payload) => {
                              if (props) {
                                // const xValue = props.payload[0].value; // 横軸の値
                                const yValue = value; // 縦軸の値
                                console.log(props.payload.x);
                                return [`payload: ${payload}`, `props: ${props}`, `x: ${payload}`, `y: ${Number(yValue).toExponential()}`];
                              }
                              return [];
                            }}
                          />
