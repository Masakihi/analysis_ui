                  ...
                  <Box display="flex" alignItems="center" justifyContent="center" sx={{ minHeight: 800, width: 400, flexDirection: 'column' }}>
                    ...
                    <List>
                      {dataList.map((data, index) => (
                        <ListItem key={index}>
                          <TextField type="number" value={data.min} onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange(index, 'min', Number(e.target.value))} />
                          ～
                          <TextField type="number" value={data.max} onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange(index, 'max', Number(e.target.value))} />
