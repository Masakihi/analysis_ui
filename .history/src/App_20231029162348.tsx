...
const App: React.FC = () => {
  ...
  useEffect(() => {
    if (qList !== undefined && iList !== undefined) {
      ...
      setGraphDatasets(dataPoints.slice(0, 3));
                ...
                <Grid item xs={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Box display="flex" alignItems="center" justifyContent="center" sx={{ minHeight: 800, width: 400 }}>
                    {qList !== undefined && iList !== undefined ? (
                      <div className="App">
                        <LineChart width={800} height={400} data={graphDatasets}>
                          <CartesianGrid strokeDasharray="3 3" />
                          <XAxis dataKey="x" type="number" scale="log" domain={[0.0001, 2]} />
                          <YAxis dataKey="y" type="number" scale="log" domain={[0.1, 100000]} />
                          <Tooltip />
                          <Legend />
