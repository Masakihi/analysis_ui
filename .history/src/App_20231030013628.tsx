...
const App: React.FC = () => {
  ...
  console.log(`horozontalIList: ${horizontalIList}`);
              ...
              <Grid container spacing={2}>
                <Grid item xs={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Box display="flex" alignItems="center" justifyContent="center" sx={{ minHeight: 800, width: 400, flexDirection: 'column' }}>
                    ...
                    <Box>
                      <Button variant="contained" onClick={handleScanHorizontal} style={{ margin: '5px 5px' }}>
                        水平スキャン
                      </Button>
                    </Box>
              ...
              <Grid container spacing={2}>
                <Grid item xs={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Box display="flex" alignItems="center" justifyContent="center" sx={{ minHeight: 800, width: 400, flexDirection: 'column' }}>
                    ...
                    <Box>
                      <Button variant="contained" onClick={handleScanVertical} style={{ margin: '5px 5px' }}>
                        垂直スキャン
                      </Button>
                    </Box>
